...
export const BANNER_RESTORE_REQUEST = "BANNER_RESTORE_REQUEST";
export const BANNER_RESTORE_SUCCESS = "BANNER_RESTORE_SUCCESS";
export const BANNER_RESTORE_FAIL = "BANNER_RESTORE_FAIL";
export const BANNER_RESTORE_RESET = "BANNER_RESTORE_RESET";
